      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {projects.map(project => (
          <Link
            ...
            className="card-hover p-6 block group relative"
          >
            {/* Role Badge */}
            ...
            <div className="flex items-center gap-4 text-xs text-slate-400 mt-3 pt-3 border-t border-slate-50">
              ...
              <span className="flex items-center gap-1.5">
                <TrendingUp className="w-3.5 h-3.5" /> {project.taskCount || 0} tasks
              </span>
            </div>
            ...
            {project.taskCount > 0 && (
              <div className="mt-3">
                ...
                <p className="text-xs text-slate-400 mt-1">{project.progressPercent}% complete</p>
              </div>
            )}
          </Link>
        ))}
